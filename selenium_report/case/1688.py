...
# 淘宝用户名
tb_username = '15190257357'
# 淘宝密码
tb_password = '1314520trkf'
...
url = 'https://s.1688.com/company/company_search.htm?&keywords=' + urllib.request.quote(item_name.encode('gbk'))
driver.get(url)
...
for page in range(1, 2):
    ...
    try:
        ...
        # 商户页面的url
        url = 'https://s.1688.com/company/company_search.htm?&keywords=' + urllib.request.quote(item_name.encode('gbk')) + '&beginPage=' + str(page)
        print(url)
        # 跳转到商户页面的url
        driver.get(url)
        ...
        for i in range(len(title)):
            ...
            proto, rest = urllib.parse.splittype(titlehref)
